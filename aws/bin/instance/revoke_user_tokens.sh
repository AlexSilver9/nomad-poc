...
# Revoke Consul and Nomad tokens for the given user.
# Delegates to revoke_consul_user_token.sh and revoke_nomad_user_token.sh.
#
# Prerequisites:
...
"$SCRIPT_DIR/revoke_nomad_user_token.sh" "$1"
echo ""
"$SCRIPT_DIR/revoke_consul_user_token.sh" "$1"
