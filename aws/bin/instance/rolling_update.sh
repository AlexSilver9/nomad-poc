...
mkdir -p services/rolling-update-service
...
wget -q -O services/rolling-update-service/route.consul.hcl "$GITHUB_RAW_BASE/services/rolling-update-service/route.consul.hcl"
...
consul config write services/rolling-update-service/route.consul.hcl
